...
export class UserController {
  ...
  updateUserRole = async (
    ...
    try {
      ...
      if (adminId === req.params.id) {
        ...
        return sendError(
          reply,
          new SelfModificationError("You cannot change your own role")
        );
      }
  ...
  deleteUser = async (
    ...
    try {
      if (req.user!.id === req.params.id) {
        ...
        return sendError(
          reply,
          new SelfModificationError("You cannot delete your own account")
        );
      }
  ...
  toggleUserStatus = async (
    ...
    try {
      if (req.user!.id === req.params.id) {
        ...
        return sendError(
          reply,
          new SelfModificationError("You cannot toggle your own status")
        );
      }
  ...
  toggleUserVerified = async (
    ...
    try {
      ...
      logger.success(
        "toggleUserVerified",
        `Toggled verified: ${req.params.id}`
      );
      return sendSuccess(reply, updated);
    } catch (e) {
      logger.error(
        "toggleUserVerified",
        "Failed to toggle user verified status",
        e
      );
      return sendError(reply, e as Error);
    }
